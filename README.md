...
- ✍️ **Prompt editor:** one empty free-text field for every mode; Insert Prompt Structure adds the former structured template on demand. Insert [Shot N], Insert RefMod #, Prefill Labels & Summary, Preview Prompt and Prompt Forge work in that field; old structured workflows and reference packs migrate into it.
